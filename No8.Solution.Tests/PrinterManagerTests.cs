...
namespace No8.Solution.Tests
{
    ...
    public class PrinterManagerTests
    {
        ...
        public void Test()
        {
            var manager = PrinterManager.GetInstance;
            Factory factory = new Factory();

            
            Printer printer = factory.CreatePrinter("epson", "1234");
            manager.Add(printer);

            manager.Print(printer, @"E:\Epam\ExtTraining.Autumn.2018.2\.gitignore");
        }
    }
}
